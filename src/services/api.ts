...
export const api = {
  ...
  delete: <T>(endpoint: string) =>
    client.delete<T>(endpoint).then((r) => r.data),
};
...
export const createDoctor = (
  body: import("./types").CreateDoctorRequest | FormData
) =>
...
export const updateDoctor = (
  doctorId: string,
  body: import("./types").UpdateDoctorRequest | FormData
) =>
  body instanceof FormData
    ? client
...
export const updateDoctorSchedule = (
  doctorId: string,
  body: import("./types").UpdateScheduleRequest
) =>
  api.post<import("./types").UpdateScheduleResponse>(
...
export const pauseSchedule = (
  ...
  api.post<import("./types").PauseScheduleResponse>(
    `/doctors/schedules/${scheduleId}/pause`,
    body
  );

export const cancelSchedulePause = (pauseId: string) =>
  api.patch<import("./types").PauseScheduleResponse>(
...
export const createClinic = (body: FormData) =>
  client
    .post<import("./types").CreateClinicResponse>("/clinics", body, {
      headers: { "Content-Type": "multipart/form-data" },
    })
    .then((r) => r.data);
...
export const getSubscriptionStatus = () =>
  api.get<{ success: boolean; data: { trialExpiresAt: string; subscriptionStatus: string } }>('/subscriptions/status')
...
export const updateClinic = (body: FormData) =>
  client
    .patch<{ success: boolean; data: import("./types").ClinicData }>(
      "/clinics/me",
      body,
      {
        headers: { "Content-Type": "multipart/form-data" },
